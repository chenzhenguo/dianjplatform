...
//    public static void sendMessage(String json,SystemService systemService){
//    	// 调用接口获取access_token
//        AccessToken at = WeixinUtil.getAccessToken(systemService);
//        if(at!=null){
//        	org.jeecgframework.core.util.LogUtil.info("....token...."+at.getToken());
//        	String url = send_message_url.replace("ACCESS_TOKEN",at.getToken());
//        	JSONObject jsonObject = httpRequest(url, "POST", json);
//        	org.jeecgframework.core.util.LogUtil.info("...jsonObject..."+jsonObject.toString());
//        }
//    }
