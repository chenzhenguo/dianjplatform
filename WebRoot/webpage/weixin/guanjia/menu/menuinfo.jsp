   ...
   <table style="width:100%" cellpadding="0" cellspacing="1" class="formtable">
    ...
    <tr id="xxtr" style="width:65px">
     ...
     <td class="value" colspan="3">
       <input type="radio" value="text" name="msgType"  <c:if test="${msgType=='text'}">checked="checked"</c:if> dataType="*" nullmsg="请选择消息类型" />文本
       <input type="radio" value="news" name="msgType"  <c:if test="${msgType=='news'}">checked="checked"</c:if> dataType="*" nullmsg="请选择消息类型"/>图文
    ...
    <tr id="templateTr" style="width:65px">
     ...
     <td class="value" colspan="3">
      <select name="templateId" id="templateId" dataType="*" nullmsg="请选择模板">
    ...
    <tr>
     ...
     <td class="value" colspan="3">
      <input id="url" class="inputxt"  dataType="*" nullmsg="请填写菜单标识" name="menuKey" value="${menuKey}" >
