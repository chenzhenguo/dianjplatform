 			...
 			<div class="appmsg_editor" style="margin-top: 0px;">
				...
				<table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
							     	 <input id="wxTitle" name="wxTitle" type="text" style="width: 150px" class="inputxt"  datatype="*">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="wxAuthor" name="wxAuthor" type="text" style="width: 150px" class="inputxt" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="wxContent" id="wxContent"></textarea>
							    <script type="text/javascript">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="wxOriginUrl" name="wxOriginUrl" type="text" style="width: 150px" class="inputxt">
									<span class="Validform_checktip"></span>
