...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        $("#progress").hide();
		var d = $.parseJSON(data.result.jsonStr);
		if (d.success) {
        	...
        	$("#wxPicUrl").val(d.attributes.viewhref);
		}else{
 ...
 <body>
 			...
 			<div class="appmsg_editor" style="margin-top: 0px;">
				...
				<table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
							     	 <input id="wxTitle" name="wxTitle" type="text" value="${weixinArticlePage.wxTitle}" style="width: 150px" class="inputxt"  datatype="*">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="wxAuthor" name="wxAuthor" type="text" value="${weixinArticlePage.wxAuthor}" style="width: 150px" class="inputxt" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="wxPicUrl" name="wxPicUrl" type="hidden"  datatype="*" nullmsg="请添加图片">
							    </span>
						...
						<tr>
							...
							<td class="value">
							     	 <input id="wxSummary" name="wxSummary"  type="text" style="width: 150px" class="inputxt"  
										   value="${weixinArticlePage.wxSummary}"            
										               >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="wxContent" id="wxContent">${weixinArticlePage.wxContent}</textarea>
							    <script type="text/javascript">
							        var editor = UE.getEditor('wxContent');
							    </script>
								</td>
						</tr>
						<tr>
							...
							<td class="value">
							     	 <input id="wxOriginUrl" name="wxOriginUrl" value="${weixinArticlePage.wxOriginUrl}" type="text" style="width: 150px" class="inputxt">
									<span class="Validform_checktip"></span>
									<label class="Validform_label" style="display: none;">原文链接</label>
								</td>
						</tr>
					</table>
				</t:formvalid>
  ...
  <script src = "webpage/weixin/article/weixinArticle.js"></script>		