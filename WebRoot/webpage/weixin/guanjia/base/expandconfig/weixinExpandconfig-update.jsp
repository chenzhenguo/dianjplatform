...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinExpandconfigController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="keyword" name="keyword" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${weixinExpandconfigPage.keyword}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="classname" name="classname" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${weixinExpandconfigPage.classname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountid" name="accountid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinExpandconfigPage.accountid}'>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">微信公众帐号</label>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinExpandconfigPage.name}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="content" name="content" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${weixinExpandconfigPage.content}'>
							<span class="Validform_checktip"></span>
