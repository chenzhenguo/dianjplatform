...
<body>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="http://www.fenggun.net" title="丰滚科技">丰滚</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="http://www.fenggun.net" title="丰滚科技">丰滚科技</a></span></div>
    </div>
    <!-- Link JScript-->
