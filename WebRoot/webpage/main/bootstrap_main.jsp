...
<div class="container-fluid"><a class="brand" href="http://www.fenggun.net" target="_blank">JEECG 演示系统 &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="http://www.fenggun.net" title="JEECG Framework 3.4.3 GA">JEECG Framework 3.4.3 GA</a></li>
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度) 技术支持:<a title="JEECG Framework 3.4.3 GA版本" href="http://www.fenggun.net">JEECG Framework 3.4.3 GA</a></li>
</ul>
</div>
</footer>
